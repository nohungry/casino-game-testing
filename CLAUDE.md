...
- **Skill 不跨站、不登入、不換品牌** — 使用者自己開瀏覽器、登入、滿版、停在**該品牌遊戲大廳**（另開好後台投注報表分頁），Skill 從當前頁接手；**品牌內選款、進入遊戲、退出遊戲由 AI 自行操作**（calibrate 自挑大廳第一款當 sample、run 逐款自開）。不替使用者跨站點導航、不登入、不切到別的品牌。
